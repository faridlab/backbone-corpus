//! ArticleCategory DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ArticleCategory
///
...
/// Request DTO for full update of a ArticleCategory
///
...
/// Request DTO for partial update of a ArticleCategory
///
...
/// Response DTO for ArticleCategory entity
///
...
/// Paginated list response for ArticleCategory entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ArticleCategoryListResponseDto {
    /// List of items
    pub items: Vec<ArticleCategoryResponseDto>,
...
impl From<ArticleCategory> for ArticleCategoryResponseDto {
...
impl From<ArticleCategory> for ArticleCategorySummaryDto {
    fn from(entity: ArticleCategory) -> Self {
...
impl From<CreateArticleCategoryDto> for ArticleCategory {
...
impl backbone_core::FromCreateDto<CreateArticleCategoryDto> for ArticleCategory {
    fn from_create_dto(dto: CreateArticleCategoryDto) -> backbone_core::ServiceResult<Self> {
        Ok(ArticleCategory::from(dto))
    }
}
