//! ArticleFeedback DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ArticleFeedback
///
...
/// Request DTO for full update of a ArticleFeedback
///
...
/// Request DTO for partial update of a ArticleFeedback
///
...
/// Response DTO for ArticleFeedback entity
///
...
/// Paginated list response for ArticleFeedback entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ArticleFeedbackListResponseDto {
    /// List of items
    pub items: Vec<ArticleFeedbackResponseDto>,
...
impl From<ArticleFeedback> for ArticleFeedbackResponseDto {
...
impl From<ArticleFeedback> for ArticleFeedbackSummaryDto {
    fn from(entity: ArticleFeedback) -> Self {
...
impl From<CreateArticleFeedbackDto> for ArticleFeedback {
...
impl backbone_core::FromCreateDto<CreateArticleFeedbackDto> for ArticleFeedback {
    fn from_create_dto(dto: CreateArticleFeedbackDto) -> backbone_core::ServiceResult<Self> {
        Ok(ArticleFeedback::from(dto))
    }
}
