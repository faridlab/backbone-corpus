//! Specifications for ArticleFeedback aggregate
//!
...
// Each predicate implements `Specification<ArticleFeedback>` and can be combined
...
//
// pub struct ActiveArticleFeedbackSpec;
// impl Specification<ArticleFeedback> for ActiveArticleFeedbackSpec {
//     fn is_satisfied_by(&self, e: &ArticleFeedback) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
