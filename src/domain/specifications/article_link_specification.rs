//! Specifications for ArticleLink aggregate
//!
...
// Each predicate implements `Specification<ArticleLink>` and can be combined
...
//
// pub struct ActiveArticleLinkSpec;
// impl Specification<ArticleLink> for ActiveArticleLinkSpec {
//     fn is_satisfied_by(&self, e: &ArticleLink) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
